...
namespace KerkenezTicket.Models
{
    ...
    public static class TicketStatusExtensions
    {
        ...
        {
            TicketStatus.Backlog => Color.FromArgb(114, 9, 183),     // Violet / Purple
        ...
        {
            TicketStatus.Backlog => Color.FromArgb(245, 235, 255),
        ...
        {
            TicketStatus.Backlog => "\uE81C",   // Archive / backlog / clipboard
        ...
        public static TicketStatus ParseStatus(string? value)
        {
            ...
            {
                "backlog" or "later" or "icebox" or "future" or "planning" => TicketStatus.Backlog,
                "todo" or "open" or "pending" => TicketStatus.Todo,
